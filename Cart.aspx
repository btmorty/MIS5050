<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cart.aspx.cs" MasterPageFile="ustora.master" Inherits="InClassExersice_ustora_Cart" %>


<asp:Content runat="server" ID="Content2" ContentPlaceHolderID="cphHead">
    <title>Ustora Cart</title>
</asp:Content>
                                ...
                                <ItemTemplate>
                                    <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img runat="server" width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src='<%# Eval("ID", "~/DataControls/Images/{0}.jpg") %>'></a>
                                            </td>
